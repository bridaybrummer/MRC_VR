...
grid[,
    within_5km  := ifelse( dist_to_nearest_office_km <= 5,  TRUE, FALSE),
    ][,
...
grid%>%
    mutate( 
        within_5km  = if_else( dist_to_nearest_office_km <= 5,  TRUE, FALSE),
...
dha_access_10km_summary[,
    .(
        ...
        pop_within_5km  = sum( pop_within_5km,  na.rm = TRUE),
...
flextable::set_header_labels( 
    ...
    pop_within_5km  = "Population within 5 km",
    pct_within_5km  = "% Population within 5 km",
